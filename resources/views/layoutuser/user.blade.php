    ...
    <div class="content">
        ...
        <div class="container-fluid pt-4 px-4">
            <div class="row vh-100 bg-light rounded justify-content-center mx-0">
                ...
                <div class="col-12 ">
                    <h4 style="text-align: center">Form Prediksi Kelulusan Mahasiswa</h4>

                    <form action="{{ route('useraksi') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        {{-- harus ada --}}
                        ...
                        <div class="form -group mb-3">
                            ...
                            <div class="mb-3">
                                <select class="form-control" id="jekel" name="jurusan_sekolah">
                                    ...
                                    <script>
                                        document.getElementById('jurusan_sekolah').value = "";
                                    </script>
                                </select>
                            </div>
